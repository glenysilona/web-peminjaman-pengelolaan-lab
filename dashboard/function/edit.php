<?php
	...
	if (isset($_GET['admin-edit'])) {
		...
		if (isset($_POST['admin-update'])) {
			...
			$admin 		=	mysqli_query("UPDATE users 
		...
		$dataadmin 		= 	mysqli_query("SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['guru-edit'])) {
		...
		if (isset($_POST['guru-update'])) {
			...
			$guru 		=	mysqli_query("UPDATE users 
		...
		$dataguru 		= 	mysqli_query("SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['siswa-edit'])) {
		...
		if (isset($_POST['siswa-update'])) {
			...
			$siswa 		=	mysqli_query("UPDATE users 
											SET `nomor_induk` = '$noinduk', `name` = '$name', `username` = '$username', `telp` = '$telp', 
		...
		$datasiswa 		= 	mysqli_query("SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['profile'])) {
		...
		if (isset($_POST['pass-update'])) {
			...
			$users 		=	mysqli_query("UPDATE users 
		...
		$datausers 		= 	mysqli_query("SELECT * FROM users WHERE id = $id");
...
<?php
	...
	if (isset($_GET['alat-edit'])) {
		...
		if (isset($_POST['alat-update'])) {
			...
			$alat 		=	mysqli_query($koneksi,"UPDATE alat 
											SET `alat_nama` = '$nama', `alat_jenis` = '$jenis', `alat_jumlah` = '$jumlah'
											WHERE alat_id = '$id'");
			if ($alat) {
				echo 	"<div class='alert alert-success alert-dismissable'>
							<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
		...
		$dataalat		= 	mysqli_query($koneksi,"SELECT * FROM alat WHERE alat_id = $id");
...
<?php
	...
	if (isset($_GET['bahan-edit'])) {
		...
		if (isset($_POST['bahan-update'])) {
			...
			$bahan 		=	mysqli_query("UPDATE bahan 
		...
		$databahan		= 	mysqli_query("SELECT * FROM bahan WHERE bahan_id = $id");
...
<?php
	...
	if (isset($_GET['kelas-edit'])) {
		...
		if (isset($_POST['kelas-update'])) {
			...
			$kelas 		=	mysqli_query("UPDATE kelas 
											SET `kelas_nama` = '$nama'
											WHERE kelas_id = '$id'");
			if ($kelas) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datakelas		= 	mysqli_query("SELECT * FROM kelas WHERE kelas_id = $id");
...
<?php
	...
	if (isset($_GET['semester-edit'])) {
		...
		if (isset($_POST['semester-update'])) {
			...
			$semester 		=	mysqli_query("UPDATE semester 
		...
		$datasemester	= 	mysqli_query("SELECT * FROM semester WHERE semester_id = $id");
...
<?php
	...
	if (isset($_GET['tahun-edit'])) {
		...
		if (isset($_POST['tahun-update'])) {
			...
			$tahun 		=	mysqli_query("UPDATE tahun 
											SET `tahun_nama` = '$nama'
											WHERE tahun_id = '$id'");
			if ($tahun) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datatahun		= 	mysqli_query("SELECT * FROM tahun WHERE tahun_id = $id");
...
<?php
	...
	if (isset($_GET['jenis-edit'])) {
		...
		if (isset($_POST['jenis-update'])) {
			...
			$jenis 		=	mysqli_query("UPDATE jenisnilai 
											SET `jenis_nama` = '$nama'
											WHERE jenis_id = '$id'");
			if ($jenis) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datajenis		= 	mysqli_query("SELECT * FROM jenisnilai WHERE jenis_id = $id");
...
<?php
	...
	if (isset($_GET['jadwal-edit'])) {
		...
		if (isset($_POST['jadwal-update'])) {
			...
			$jadwal 		=	mysqli_query("UPDATE jadwal 
		...
		$datajadwal		= 	mysqli_query("SELECT * FROM jadwal WHERE jadwal_id = $id");
...
<?php
	...
	if (isset($_GET['jam-edit'])) {
		...
		$datajam		= 	mysqli_query("SELECT * FROM jam WHERE jam_id = $id");
...
<?php
	...
	if (isset($_GET['jenisperangkat-edit'])) {
		...
		if (isset($_POST['jenisperangkat-update'])) {
			...
			$jenis 		=	mysqli_query("UPDATE jenisperangkat 
		...
		$datajenis		= 	mysqli_query("SELECT * FROM jenisperangkat WHERE jenisperangkat_id = $id");
		$row 			= 	mysqli_fetch_array($datajenis);
	}
?>
<?php
	...
	if (isset($_GET['afektif-edit'])) {
		...
		if (isset($_POST['afektif-update'])) {
			...
			$afektif 		=	mysqli_query("UPDATE nilai 
											SET `nilai_poin` = '$poin'
											WHERE nilai_id = '$id'");
			if ($afektif) {
				echo 	"<div class='alert alert-success alert-dismissable'>
		...
		$datanilai		= 	mysqli_query("SELECT * FROM nilai WHERE nilai_id = $id");
...
<?php
	...
	if (isset($_GET['kognitif-edit'])) {
		...
		if (isset($_POST['kognitif-update'])) {
			...
			$kognitif 		=	mysqli_query("UPDATE nilai 
											SET `nilai_poin` = '$poin'
											WHERE nilai_id = '$id'");
			if ($kognitif) {
				echo 	"<div class='alert alert-success alert-dismissable'>
...
<?php
	...
	if (isset($_GET['psikomotor-edit'])) {
		...
		if (isset($_POST['psikomotor-update'])) {
			...
			$psikomotor 		=	mysqli_query("UPDATE nilai 
											SET `nilai_poin` = '$poin'
											WHERE nilai_id = '$id'");
			if ($psikomotor) {
				echo 	"<div class='alert alert-success alert-dismissable'>
