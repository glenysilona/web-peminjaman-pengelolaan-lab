<?php 
	...
	if (isset($_GET['admin-delete'])) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM alat WHERE alat_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM bahan WHERE bahan_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM kelas WHERE kelas_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM semester WHERE semester_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM tahun WHERE tahun_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM jenisnilai WHERE jenis_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM jenisperangkat WHERE jenisperangkat_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM nilai WHERE nilai_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM download WHERE id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM jadwal WHERE jadwal_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM jam WHERE jam_id = $id");
		if ($delete) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM galeri WHERE galeri_id = $id");
		if ($delete) {
