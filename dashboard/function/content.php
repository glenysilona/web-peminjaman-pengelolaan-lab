<?php 
	if (isset($_GET['users'])) {
		...
		elseif ($_GET['users'] == 'list_karyawan') {		//	Alat
			include('table/list_karyawan.php');
		}
	...
	elseif (isset($_GET['perangkat'])) {
		...
		}elseif ($_GET['perangkat'] == 'alat-create1') {
			include('function/create.php');
			include('forms/create_alat1.php');
		...
		}elseif ($_GET['perangkat'] == 'listalat') {	//	Bahan
			include('table/listalat.php');
		}
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="grid box-profile bg-blue">
			<div class="grid-body">							
				<img src="../gallery/usericon.jpg" class="img-circle" alt="User Profile">
