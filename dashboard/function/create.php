...
<?php
	...
	if (isset($_POST['create-admin'])) {
		...
		$admin 			=	mysqli_query("INSERT INTO users (`id`, `name`, `username`, `password`, `alamat`, 
...
<?php 
	...
	if (isset($_POST['create-guru'])) {
		...
		$guru 			=	mysqli_query("INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `alamat`, 
...
<?php 
	...
	if (isset($_POST['create-siswa'])) {
		...
		$siswa 			=	mysqli_query("INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `alamat`, 
													`telp`, `status`, `gender`, `foto`, `kelas_id`, `access`) 
...
<?php 
	...
	if (isset($_POST['create-alat'])) {
		...
		$koneksi =	mysqli_connect('localhost','root','','siml')or die('Gagal Koneksi');
		$alat =	mysqli_query($koneksi,"INSERT INTO `alat`(`alat_id`, `tgl`, `alat_nama`, `alat_jenis`, `alat_jumlah`,`Status`) VALUES ('NULL','$tanggal','$nama','$jenis','$jumlah', '$status')");
		header('location: ../index.php?perangkat=alat');
		}			
...
<?php 
	...
	if (isset($_POST['create-bahan'])) {
		...
		$koneksi =	mysqli_connect('localhost','root','','siml')or die('Gagal Koneksi');
		$bahan 		=	mysqli_query($koneksi,"INSERT INTO bahan (`bahan_id`, `bahan_nama`, `bahan_jenis`, `bahan_jumlah`, `bahan_rusak`) 
										VALUES (NULL, '$nama', '$jenis', '$jumlah', '$rusak')");
...
<?php 
	...
	if (isset($_POST['create-kelas'])) {
		...
		$kelas 			=	mysqli_query("INSERT INTO kelas (`kelas_id`, `kelas_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-semester'])) {
		...
		$semester 			=	mysqli_query("INSERT INTO semester (`semester_id`, `semester_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-tahun'])) {
		...
		$tahun 			=	mysqli_query("INSERT INTO tahun (`tahun_id`, `tahun_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-jenis'])) {
		...
		$jenis 			=	mysqli_query("INSERT INTO jenisnilai (`jenis_id`, `jenis_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	...
	if (isset($_POST['create-jenisperangkat'])) {
		...
		$jenis 			=	mysqli_query("INSERT INTO jenisperangkat (`jenisperangkat_id`, `jenisperangkat_nama`, `jenisperangkat_type`) 
...
<?php 
	...
	if (isset($_POST['create-jadwal'])) {
		...
		$jadwal 			=	mysqli_query("INSERT INTO jadwal (`jadwal_id`, `jam_id`, `jadwal_tanggal`, `id`, `kelas_id`) 
...
<?php 
	...
	if (isset($_POST['create-jam'])) {
		...
		$jam 			=	mysqli_query("INSERT INTO jam (`jam_id`, `jam_nama`) 
										VALUES (NULL, '$nama')");
...
<?php 
	if (isset($_POST['afektif-proses'])) {
		...
		for($x=0;$x<$jumlahdata;$x++) {
			$nilai	=	mysqli_query("INSERT INTO nilai (`nilai_id`, `id`, `jenis_id`, `semester_id`, `tahun_id`, `nilai_poin`) 
...
<?php
    ...
    if (isset($_POST['upload-foto'])) {
        ...
        $galeri = mysqli_query("INSERT INTO galeri (galeri_nama, galeri_keterangan, galeri_link, galeri_tgl) VALUES('$nama','$keterangan','$link', now())");
...
<?php 
	if (isset($_POST['absen-proses'])) {
		...
		for($x=0;$x<$jumlahdata;$x++) {
			$absen	=	mysqli_query("INSERT INTO absen (`absen_id`, `id`, `absen_tgl`, `absen_ket`) 
